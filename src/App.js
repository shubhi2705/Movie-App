...
import MovieList from './components/MovieList';
 ...
 function App() {
  const FEATURED_API="https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=822b219cd25e68c27f21852480a0698b&page=1";
  ...
  useEffect(()=>{
 fetchMovies(FEATURED_API).then(data=>{
